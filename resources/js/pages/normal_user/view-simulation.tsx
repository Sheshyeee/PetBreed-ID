    ...
    const ImageCard = ({
        ...
        <div className="vs-imgcard relative flex flex-col overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm dark:border-white/[.07] dark:bg-[#131720]">
            ...
            <div className="flex flex-shrink-0 items-center gap-2 border-b border-slate-200 bg-slate-50/80 px-4 py-2.5 dark:border-white/[.06] dark:bg-white/[.025]">
                ...
                <span className="vs-mono text-[10px] font-bold tracking-[.12em] text-slate-600 uppercase dark:text-slate-400">
                    {label}
                </span>
            </div>
                ...
                {isLoading ? (
                    <div className="flex h-full flex-col items-center justify-center gap-4">
                        ...
                        <div className="text-center">
                            ...
                            <p className="vs-mono text-[9px] tracking-[.1em] text-slate-500 uppercase dark:text-slate-500">
                                AI processing
                            </p>
                        </div>
                    </div>
                    ...
                    <>
                        ...
                        <div
                            ...
                            style={{
                                background:
                                    'repeating-linear-gradient(0deg,transparent,transparent 2px,rgba(0,0,0,.012) 2px,rgba(0,0,0,.012) 4px)',
                            }}
                        />
                        {/* HUD corners */}
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <div>
                                    <div className="mb-1 inline-flex items-center gap-2 rounded-full border border-violet-500/20 bg-violet-500/[.07] px-2.5 py-0.5">
                                        <span
                                            className="h-1.5 w-1.5 rounded-full bg-violet-500 shadow-[0_0_6px_#a855f7]"
                                            style={{
                                                animation:
                                                    'vs-dpulse 2s ease-in-out infinite',
                                            }}
                                        />
                                        <span className="vs-mono text-[9px] font-semibold tracking-[.12em] text-violet-700 uppercase dark:text-violet-400">
                                            Age Simulation
                                        </span>
                                    </div>
                        ...
                        <div className="vs-fu vs-fu1 mb-5 flex items-start gap-3.5 rounded-2xl border border-amber-200 bg-amber-50 p-4 dark:border-amber-500/20 dark:bg-amber-500/[.06]">
                            ...
                            <div>
                                ...
                                <p className="mt-0.5 text-xs leading-relaxed text-amber-700/80 dark:text-amber-400/80">
                                    This prediction shows your dog 1 and 3 years
                                    from today based on current age and breed
                                    patterns. Actual aging may vary depending on
                                ...
                                <div className="vs-fu vs-fu2">
                                    <div className="relative overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm dark:border-white/[.07] dark:bg-[#131720]">
                                        ...
                                        <div className="flex flex-col items-center justify-center gap-6 py-20 text-center">
                                            <div className="relative">
                                                <div
                                                    className="absolute inset-[-16px] rounded-full border border-violet-500/15"
                                                    style={{
                                                        animation:
                                                            'vs-ping 2s ease-out infinite',
                                                    }}
                                                />
                                                <div
                                                    ...
                                                    style={{
                                                        animation:
                                                            'vs-ping 2s ease-out infinite .4s',
                                                    }}
                                                />
                                            ...
                                            <div>
                                                ...
                                                <p className="mt-1 text-sm text-slate-600 dark:text-slate-400">
                                                    Creating AI age progression
                                                    images. This takes 40–60
                                                    seconds.
                                                </p>
                                                <p className="vs-mono mt-2 text-[10px] tracking-[.1em] text-slate-500 dark:text-slate-500">
                            ...
                            <div className="vs-fu vs-fu2">
                                <div className="relative overflow-hidden rounded-2xl border border-red-200 bg-red-50 shadow-sm dark:border-red-500/20 dark:bg-red-500/[.06]">
                                    <div className="flex flex-col items-center justify-center gap-5 py-20 text-center">
                                        ...
                                        <div>
                                            <p className="text-lg font-extrabold text-red-800 dark:text-red-200">
                                                Simulation failed
                                            </p>
                                            <p className="mt-1 text-sm text-red-700/80 dark:text-red-400/80">
                                                We couldn't generate the age
                                                simulations. Please try again
                                                later.
                                            </p>
                                        </div>
                                        <Link
                                            href="/scan-results"
                                            className="inline-flex items-center gap-2 rounded-xl bg-red-500 px-5 py-2.5 text-[13px] font-bold text-white no-underline transition-all hover:bg-red-400"
                                        >
                                            <ArrowLeft size={13} /> Back to
                                            Results
                                        </Link>
                                    </div>
                                </div>
                            ...
                            <div className="vs-fu vs-fu2">
                                ...
                                <div className="grid grid-cols-1 gap-5 sm:grid-cols-2">
                                    ...
                                    <div className="relative flex flex-col overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm dark:border-white/[.07] dark:bg-[#131720]">
                                        ...
                                        >
                                            ...
                                            />
                                            <div
                                                className="vs-sweep pointer-events-none absolute inset-0"
                                                style={{
                                                    background:
                                                        'linear-gradient(180deg,transparent 0%,rgba(16,185,129,.04) 46%,rgba(16,185,129,.1) 50%,rgba(16,185,129,.04) 54%,transparent 100%)',
                                                }}
                                            />
                                            {[
                                                'vs-htl',
                                ...
                                <div className="mt-5 grid grid-cols-2 gap-4 sm:grid-cols-4">
                                    {[
                                        ...
                                        {
                                            label: '1 Year',
                                            value: simulations['1_years']
                                                ? 'Ready'
                                                : 'Generating',
                                        },
                                        {
                                            label: '3 Years',
                                            value: simulations['3_years']
                                                ? 'Ready'
                                                : 'Generating',
                                        },
                                    ].map((stat, i) => (
                                        <div
                                            key={i}
                                            className="flex flex-col gap-0.5 rounded-xl border border-slate-200 bg-white px-4 py-3 dark:border-white/[.07] dark:bg-[#131720]"
                                        >
                                            <span className="vs-mono text-[9px] tracking-[.1em] text-slate-500 uppercase dark:text-slate-500">
                                                {stat.label}
                                            </span>
                                            <span
                                                className={`text-[13px] font-bold ${stat.value === 'Ready' ? 'text-emerald-600 dark:text-emerald-400' : stat.value === 'Generating' ? 'text-amber-600 dark:text-amber-400' : 'text-slate-800 dark:text-slate-200'}`}
                                            >
                                                {stat.value}
                                            </span>
                                        </div>
