...
export default function Scan() {
    ...
    const Panel = ({
        ...
        <div className="relative flex flex-col overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm dark:border-white/[.07] dark:bg-[#131720]">
            <div className="flex flex-shrink-0 items-center gap-2 border-b border-slate-200 bg-slate-50/80 px-3 py-2.5 dark:border-white/[.06] dark:bg-white/[.025]">
                ...
                <span className="font-mono text-[10px] font-bold tracking-[.12em] text-slate-400 uppercase dark:text-slate-500">
                    {title}
                </span>
            </div>
            {children}
    ...
    const TopBreedsContent = () => (
        <div className="flex flex-col gap-0.5 p-2.5">
            {topBreeds.length === 0 ? (
                <p className="py-3 text-center font-mono text-[10px] text-slate-300 dark:text-slate-600">
                    No scan data yet
                </p>
            ) : (
                topBreeds.map((b, i) => (
                    ...
                    >
                        <span className="w-4 flex-shrink-0 font-mono text-[9px] text-slate-300 group-hover:text-emerald-500/50 dark:text-slate-600">
                            #{i + 1}
                        </span>
                        <span
            ...
            {[
                ...
                >
                    <div className="flex items-center gap-2">
                        ...
                        <span className="font-mono text-[9px] font-medium tracking-[.1em] text-slate-400 uppercase dark:text-slate-500">
                            {s.l}
                        </span>
                    </div>
                    <span className="font-mono text-[12px] font-bold text-slate-700 dark:text-slate-200">
                        {s.v}
                    </span>
                </div>
            ))}
            ...
            <div className="sc-root flex h-screen flex-col overflow-hidden bg-slate-50 transition-colors duration-300 dark:bg-[#080B0F]">
                ...
                <div className="relative z-10 min-h-0 flex-1 overflow-hidden">
                    {/* 
                        ...
                        - Desktop (lg+): 3-col grid with sidebars
                    */}
                        ...
                        <div className="flex flex-col gap-3 p-3 pb-24 lg:grid lg:h-full lg:grid-cols-[210px_1fr_220px] lg:grid-rows-[1fr] lg:gap-4 lg:overflow-hidden lg:p-4 lg:pb-4 xl:grid-cols-[224px_1fr_232px]">
                            ...
                            <div className="sc-fu flex min-h-0 flex-col gap-3">
                                ...
                                <div className="sc-maincard relative flex flex-shrink-0 flex-col overflow-hidden rounded-2xl border border-slate-200 bg-white shadow-sm lg:min-h-0 lg:flex-1 dark:border-white/[.07] dark:bg-[#131720]">
                                    ...
                                    {/* Form — scrollable on mobile, fills on desktop */}
                                    <form
                                    ...
                                    >
                                        ...
                                        {!preview && !showCamera && (
                                            <div className="flex flex-col gap-3">
                                                <div
                                                    className={`sc-dz flex min-h-[200px] cursor-pointer flex-col items-center justify-center gap-4 rounded-2xl border-2 border-dashed px-6 py-8 transition-all lg:min-h-[240px] ${isDragging ? 'sc-dz-on border-emerald-500 bg-emerald-500/[.04] dark:bg-emerald-500/[.06]' : 'border-slate-200 hover:border-emerald-400 hover:bg-emerald-500/[.02] dark:border-white/[.09] dark:hover:border-emerald-500/50'}`}
                                                    onClick={() =>
                                ...
                                {/* MOBILE-ONLY: Top Breeds + Global Stats — shown below scan card on mobile/tablet */}
