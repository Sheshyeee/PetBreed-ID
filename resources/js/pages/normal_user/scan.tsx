    ...
    const AppointmentBanner = () => {
        ...
        return (
            <Link
                ...
                style={{
                    boxShadow:
                        '0 4px 24px rgba(99,102,241,.18), 0 1px 4px rgba(0,0,0,.08)',
                }}
            >
                {/* ── Left: vivid icon zone ──────────────────────────────── */}
                <div
                    className="bnr-icon relative flex w-[58px] flex-shrink-0 flex-col items-center justify-center overflow-hidden"
                    style={{
                        background:
                            'linear-gradient(145deg, #4f46e5 0%, #06b6d4 100%)',
                    }}
                >
                    <div
                    ...
                    {count > 1 && (
                        <span
                            className="relative z-10 mt-1 flex h-4 min-w-[16px] items-center justify-center rounded-full bg-white px-1 font-mono text-[8px] font-black"
                            style={{ color: '#4f46e5' }}
                        >
                            {count}
                        </span>
                ...
                <div className="flex flex-1 items-center justify-between gap-4 border border-l-0 border-indigo-200/70 bg-indigo-50 px-4 py-3 transition-colors group-hover:bg-indigo-100/70 dark:border-indigo-400/15 dark:bg-[#1a1f35] dark:group-hover:bg-indigo-400/[.08]">
                    <div className="min-w-0 flex-1">
                        <div className="mb-1 flex items-center gap-2">
                            ...
                            />
                            <span className="font-mono text-[9px] font-black tracking-[.18em] text-indigo-500 uppercase dark:text-indigo-400">
                                Vet Appointment
                            </span>
                            {count > 1 && (
                        ...
                        <p className="truncate text-[13px] leading-tight font-extrabold text-slate-900 dark:text-white">
                            {count === 1
                    ...
                    <div
                        className="bnr-cta flex flex-shrink-0 items-center gap-1.5 rounded-xl bg-indigo-600 px-3.5 py-2.5 text-[12px] font-bold text-white"
                        ...
                        <div className="flex flex-col gap-3 p-3 pb-24 lg:grid lg:grid-cols-[210px_1fr_220px] lg:gap-4 lg:p-4 lg:pb-16 xl:grid-cols-[224px_1fr_232px]">
                            ...
                            <div className="sc-nsb hidden lg:flex lg:flex-col lg:gap-3 lg:py-4">
                                ...
                                >
                                    <div className="flex flex-col gap-1 p-2.5">
                                        <Link
                                            href="/scan"
                                            className="flex items-center gap-2 rounded-xl border border-emerald-500/25 bg-emerald-500/[.09] px-3 py-2 text-[12px] font-semibold text-emerald-700 no-underline dark:bg-emerald-500/[.11] dark:text-emerald-400"
                                        >
                                            <ScanIcon size={13} />
                                            <span>New Scan</span>
                                            <ChevronRight
                                        ...
                                        <Link
                                            href="/scanhistory"
                                            className="flex items-center gap-2 rounded-xl border border-transparent px-3 py-2 text-[12px] font-semibold text-slate-600 no-underline transition-all hover:bg-slate-100 hover:text-slate-800 dark:text-slate-400 dark:hover:bg-white/[.05] dark:hover:text-slate-200"
                                        >
                                            <History size={13} />
                            ...
                            <div className="sc-fu sc-nsb flex flex-col gap-3 lg:py-4">
                                ...
                                <div className="flex flex-shrink-0 flex-wrap items-center justify-between gap-3">
                                    ...
                                    <Link
                                        href="/appointments"
                                        className="inline-flex flex-shrink-0 items-center gap-2 rounded-xl border border-slate-200 bg-white px-3.5 py-2 text-[13px] font-semibold text-slate-600 no-underline transition-all hover:border-emerald-500/30 hover:bg-emerald-500/[.03] hover:text-emerald-700 md:hidden dark:border-white/[.07] dark:bg-[#131720] dark:text-slate-400 dark:hover:text-emerald-400"
                                    >
                                        <Calendar size={14} />
                                        Appointments
                                        <ChevronRight
