            ...
            <div className="flex h-full w-full flex-col gap-6 p-4 md:p-8">
                ...
                <div>
                    ...
                    <p className="text-sm text-gray-600 dark:text-white/70">
                        Validate system prediction, provide correction if
                        necessary, and schedule a consultation.
                    </p>
                </div>
                        ...
                        <Card className="px-6 py-6 dark:bg-neutral-900">
                            ...
                            <div className="space-y-6 px-0 md:px-2">
                                ...
                                <div className="rounded-lg bg-gray-50 p-4 dark:bg-neutral-800/50">
                                    <p className="mb-3 text-sm font-medium text-gray-600 dark:text-white/70">
                                        Top Alternatives
                                    </p>
                                ...
                                <div className="mt-6">
                                    ...
                                    <div className="space-y-3">
                                        {concerns.map((c, i) => (
                                            <div
                                                key={i}
                                                className="rounded-lg border border-gray-100 bg-gray-50/50 p-4 dark:border-gray-700 dark:bg-neutral-800/30"
                                            >
                                                <div className="flex flex-wrap items-center justify-between gap-2">
                                                    ...
                                                    <span
                                                        className={`rounded-full px-2.5 py-0.5 text-xs font-medium ${riskColor(c.risk_level)}`}
                                                    >
                                                        {c.risk_level}
                                                    </span>
                                                </div>
                                                <Progress
                                                    ...
                                                    className={`mt-2 h-1.5 ${riskBar(c.risk_level)}`}
                                                />
                                ...
                                <div className="mt-6">
                                    ...
                                    <div className="grid gap-2 sm:grid-cols-2">
                                        {screenings.map((s, i) => (
                                            <div
                                                key={i}
                                                className="rounded-lg border border-green-100 bg-green-50/50 p-3 dark:border-green-900/30 dark:bg-green-900/10"
                                            >
                                ...
                                <div className="mt-6">
                                    ...
                                    <div className="flex flex-wrap gap-2">
                                        {careTips.map((tip, i) => (
                                            <span
                                                key={i}
                                                className="rounded-full border border-blue-200 bg-blue-50 px-3 py-1 text-xs text-blue-800 dark:border-blue-800/40 dark:bg-blue-900/20 dark:text-blue-300"
                                            >
                                                {tip}
                                            </span>
                                        ))}
                            ...
                            {appointment ? (
                                <div className="mt-5 space-y-4">
                                    ...
                                    <div className="grid gap-3 sm:grid-cols-2">
                                        ...
                                        <div className="rounded-lg bg-gray-50 p-3 sm:col-span-2 dark:bg-neutral-800/50">
                                            <p className="text-xs text-gray-500 dark:text-gray-400">
                                                Reason
                                            </p>
                                            <p className="mt-0.5 text-sm text-gray-800 dark:text-white">
                                                {appointment.reason}
                                            </p>
                                        </div>
                                        {appointment.notes && (
                                ...
                                >
                                    <p className="text-sm text-gray-600 dark:text-gray-400">
                                        Schedule a consultation for this dog.
                                    ...
                                    <div className="rounded-lg border border-indigo-200 bg-indigo-50/50 p-3 dark:border-indigo-900/40 dark:bg-indigo-900/10">
                                        <p className="text-xs leading-relaxed text-indigo-800 dark:text-indigo-300">
                                            ...
                                            Once you submit, the dog owner will
                                            receive a notification in their
                                            portal. The appointment will be
                                            marked as <strong>Pending</strong>{' '}
                                            until the owner accepts or declines.
                                            You will be notified of their
                                            response.
                                        </p>
                                    </div>
