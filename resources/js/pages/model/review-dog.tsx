                    ...
                    >
                        <div className="flex items-center gap-2">
                            ...
                            <h2 className="font-semibold text-gray-900 dark:text-white">
                                Breed Summary Card — <span className="text-blue-600 dark:text-blue-400">{result?.breed}</span>
                            </h2>
                        </div>
                                ...
                                <form onSubmit={submitAppointment} className="mt-5 space-y-4">
                                    ...
                                    <div className="rounded-lg border border-indigo-200 bg-indigo-50/50 p-3 dark:border-indigo-900/40 dark:bg-indigo-900/10">
                                        <p className="text-xs leading-relaxed text-indigo-800 dark:text-indigo-300">
                                            ...
                                            Once you submit, the dog owner will receive a notification in their portal.
                                            The appointment will be marked as <strong>Pending</strong> until the owner accepts or declines.
